################################################################################
# Name: adh_numerics_1spec_quaddiff_tophat.py
#
# Purpose: Numerics for 1 species memory-advection-diffusion model, with periodic
#          boundary conditions, quadratic diffusion, and a top-hat kernel
#
# Usage: python adh_numerics_1spec_quaddiff_tophat.py 100000 200000 200 1000 0.1 2 1 1 1 8 adh_ic_sigma0.1_gamma2_p1.inp 
#            ..\..\..\..\onedrive\adh\adh_1spec_qdth_100000_200000_200_1000_0.1_2_1_1_1_8.out
################################################################################
...
#    for space in range(space_granularity):
#        # Normalise due to rounding errors
#        old_u_array[space] = old_u_array[space]*(space_granularity)/(box_width*u_tot)
